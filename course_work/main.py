...
delta = float(input("Grid range (from 0 to 1): "))

p00 = np.array([float(x) for x in input("First point: ").split()])
p01 = np.array([float(x) for x in input("Second point: ").split()])
p10 = np.array([float(x) for x in input("Third point: ").split()])
p11 = np.array([float(x) for x in input("Fourth point: ").split()])
